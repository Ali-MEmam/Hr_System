...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["modules-components-job-module-job-notes"], {
  ...
  /***/
  function srcAppBusinessComponentsJobJobNoteListJobNoteListComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "JobNoteListComponent", function () {
      return JobNoteListComponent;
    });
    /* harmony import */
    ...
    var _services_job_job_notes_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../../../../services/job/job-notes.service */
    "./src/services/job/job-notes.service.ts");
    /* harmony import */


    var services_job_logs_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! services/job/logs.service */
    "./src/services/job/logs.service.ts");

    function JobNoteListComponent_div_0_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function JobNoteListComponent_div_0_Template_button_click_7_listener($event) {
          ...
          var _r453 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](5);

          return ctx_r455.open(_r453);
        });
    ...
    function JobNoteListComponent_div_1_tr_14_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function JobNoteListComponent_div_1_tr_14_Template_button_click_6_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r462);

          var _r460 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](9);

          var ctx_r461 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2);

          return ctx_r461.openColapse(_r460);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function JobNoteListComponent_div_1_tr_14_Template_div_click_8_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r462);

          var note_r458 = ctx.$implicit;

          var ctx_r463 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2);

          return ctx_r463.removeNote(note_r458.id);
        });
    ...
    function JobNoteListComponent_div_1_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function JobNoteListComponent_div_1_Template_div_click_1_listener($event) {
    ...
    function JobNoteListComponent_ng_template_4_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function JobNoteListComponent_ng_template_4_Template_button_click_3_listener($event) {
          var d_r467 = ctx.dismiss;
          return d_r467("Cross click");
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function JobNoteListComponent_ng_template_4_Template_form_ngSubmit_10_listener($event) {
          ...
          return ctx_r469.onSubmit(ctx_r469.addNote);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function JobNoteListComponent_ng_template_4_Template_button_click_23_listener($event) {
          var c_r466 = ctx.close;
          return c_r466("Close click");
        });
    ...
    var JobNoteListComponent =
    /*#__PURE__*/
    function () {
      function JobNoteListComponent(formBuilder, modalService, toster, _location, noteService, logs) {
        _classCallCheck(this, JobNoteListComponent);
      ...
      _createClass(JobNoteListComponent, [{
        key: "ngOnInit",
        ...
        value: function displayNotes() {
          ...
          this.noteService.getAllNotes().subscribe(function (data) {
            console.log(data);
            console.log(_this2.notesData);
            _this2.notesData = data;
          });
        }
        /* -------------------------------------------------------------------------- */
        ...
        key: "onSubmit",
        value: function onSubmit(addNote) {
          var _this3 = this;
          ...
          var logsObj = {
            ...
            type_user: "recruiter",
            description: "Note Added \"".concat(addNote.value.title, "\""),
            profile: "",
            created: date,
            type_activity: "Add Note"
          };
          this.logs.addLogs(logsObj).subscribe();
          this.noteService.addNote(this.addNewNote).subscribe(function (data) {
            console.log(data);

            _this3.toster.success("Note added successfully", '', {
              timeOut: 3000,
        ...
        value: function removeNote(id) {
          ...
          var yyyy = today.getFullYear();
          var date = mm + '-' + dd + '-' + yyyy;
          var noteName = this.notesData.find(function (x) {
            return x.value;
          });
          var logsObj = {
            full_name: "Mohamed Ahmed",
            username: "Mohamed Ahmed",
            type_user: "recruiter",
            description: "Note deleted \"".concat(noteName.title, "\""),
            profile: "",
            created: date,
          ...
          this.noteService.deleteNote(id).subscribe(function (data) {
            ...
            _this4.toster.success("Note Removed Successfully", '', {
              timeOut: 3000,
              positionClass: 'toast-top-full-width',
              closeButton: true
            });
            ...
            _this4.toster.error("There is Error Please Try Again", '', {
              timeOut: 3000,
              positionClass: 'toast-top-full-width',
              closeButton: true
            });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](JobNoteListComponent, [{
        ...
        return [{
          ...
          type: _services_job_job_notes_service__WEBPACK_IMPORTED_MODULE_5__["JobNotesService"]
        }, {
          type: services_job_logs_service__WEBPACK_IMPORTED_MODULE_6__["LogsService"]
        }];
      }, null);
    })();
    /***/
  ...
  /***/
  function srcModulesComponentsJobModuleJobNotesTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "jobNoteListModuel", function () {
      return jobNoteListModuel;
    });
    /* harmony import */
    ...
    var routing_jobs_routing_job_notes_routing__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! routing/jobs-routing/job-notes-routing */
    "./src/routing/jobs-routing/job-notes-routing.ts");
    /* harmony import */


    var app_business_components_job_job_note_list_job_note_list_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! app/business-components/job/job-note-list/job-note-list.component */
    "./src/app/business-components/job/job-note-list/job-note-list.component.ts");
    /* harmony import */
    ...
    var jobNoteListModuel = function jobNoteListModuel() {
      _classCallCheck(this, jobNoteListModuel);
    };

    jobNoteListModuel.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: jobNoteListModuel
    });
    jobNoteListModuel.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function jobNoteListModuel_Factory(t) {
        return new (t || jobNoteListModuel)();
      },
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], routing_jobs_routing_job_notes_routing__WEBPACK_IMPORTED_MODULE_2__["jobNoteListRoutingModuel"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["RouterModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_6__["NgbModule"], ngx_toastr__WEBPACK_IMPORTED_MODULE_7__["ToastrModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](jobNoteListModuel, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](jobNoteListModuel, [{
  ...
  /***/
  function srcRoutingJobsRoutingJobNotesRoutingTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "jobNoteListRoutingModuel", function () {
      return jobNoteListRoutingModuel;
    });
    /* harmony import */
    ...
    var app_business_components_job_job_note_list_job_note_list_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! app/business-components/job/job-note-list/job-note-list.component */
    "./src/app/business-components/job/job-note-list/job-note-list.component.ts");
    ...
    var jobNoteListRoutingModuel = function jobNoteListRoutingModuel() {
      _classCallCheck(this, jobNoteListRoutingModuel);
    };

    jobNoteListRoutingModuel.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: jobNoteListRoutingModuel
    });
    jobNoteListRoutingModuel.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function jobNoteListRoutingModuel_Factory(t) {
        return new (t || jobNoteListRoutingModuel)();
      },
      imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](jobNoteListRoutingModuel, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](jobNoteListRoutingModuel, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"],
        args: [{
  ...
  /***/
  function srcServicesJobJobNotesServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "JobNotesService", function () {
      return JobNotesService;
    });
    /* harmony import */
    ...
    /*#__PURE__*/
    function () {
      function JobNotesService(http) {
        _classCallCheck(this, JobNotesService);

        this.http = http;
        this.baseUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].baseURl;
      }

      _createClass(JobNotesService, [{
        key: "getAllNotes",
    ...
    JobNotesService.ɵfac = function JobNotesService_Factory(t) {
      return new (t || JobNotesService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]));
    };

    JobNotesService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      token: JobNotesService,
      factory: JobNotesService.ɵfac,
      providedIn: 'root'
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](JobNotesService, [{
...
//# sourceMappingURL=modules-components-job-module-job-notes-es5.js.map