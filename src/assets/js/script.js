$(document).on('ready',function(){
    ...
    $(window).on('scroll', function(){    
        ...
        if (scroll >= 50) {
            ...
            $(".wishlist-dropsec").removeClass('wishlist-dropsec').addClass("wishlist-dropsec-scroll");
            $(".my-profiles-sec").removeClass('my-profiles-sec').addClass("my-profiles-sec-scroll");
        }
        else{
            $(".forsticky").removeClass("sticky");
            $(".forsticky").addClass("");
            $(".wishlist-dropsec-scroll").removeClass('wishlist-dropsec-scroll').addClass("wishlist-dropsec");
            $(".my-profiles-sec-scroll").removeClass('my-profiles-sec-scroll').addClass("my-profiles-sec");
        }
    });  
