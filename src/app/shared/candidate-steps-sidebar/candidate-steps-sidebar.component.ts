...
@Component({
  selector: 'app-candidate-steps-sidebar',
  templateUrl: './candidate-steps-sidebar.component.html',
  styleUrls: ['./candidate-steps-sidebar.component.scss'],
  animations: customAnimations

})
export class CandidateStepsSidebarComponent implements OnInit {
