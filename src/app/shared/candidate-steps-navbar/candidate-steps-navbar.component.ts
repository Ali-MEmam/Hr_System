...
@Component({
  selector: 'app-candidate-steps-navbar',
  templateUrl: './candidate-steps-navbar.component.html',
  styleUrls: ['./candidate-steps-navbar.component.scss']
})

export class CandidateStepsNavbarComponent implements OnInit, AfterViewInit {
  currentLang = "en";
