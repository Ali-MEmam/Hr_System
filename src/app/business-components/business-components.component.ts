...
@Component({
  selector: 'app-business-components',
  templateUrl: './business-components.component.html',
  styleUrls: ['./business-components.component.scss']
})
export class BusinessComponentsComponent implements OnInit {
