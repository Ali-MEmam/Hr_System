...
export class TecnicalTestComponent implements OnInit {
  ...
  displayTests() {
    this.testMangmentService.gettests().subscribe(data => {
      let techTest = data.filter(test => test.type == "tecnical");
      console.log(techTest);
      this.testData = techTest;
      this.rows = techTest;
...
//     private toast: ToastrService,private tests:HrTestService
//   ) { }
