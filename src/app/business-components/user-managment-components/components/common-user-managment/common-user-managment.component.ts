...
@Component({
  selector: 'app-common-user-managment',
  templateUrl: './common-user-managment.component.html',
  styleUrls: ['./common-user-managment.component.scss']
})
export class CommonUserManagmentComponent implements OnInit {
